...
Serial version for 16384 data sets using NVIDIA gtx device

Running the jobs
Copy the file RavishkaSerial16384.c and serial16384 files
in your winscp folder.
using putty, go to the folder that contains above two files.
using:
"sbatch serial16384" command you can execute the program
