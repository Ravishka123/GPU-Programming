...
Serial version for 4096 data sets using NVIDIA gtx device

Running the jobs
Copy the file RavishkaSerial4096.c and serial4096 files
in your winscp folder.
using putty, go to the folder that contains above two files.
using:
"sbatch serial4096" command you can execute the program
