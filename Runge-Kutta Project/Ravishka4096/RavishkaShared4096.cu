...
shared memory version for 4096 data sets using NVIDIA gtx device

Running the jobs
Copy the file RavishkaShared4096.c and shared4096 files
in your winscp folder.
using putty, go to the folder that contains above two files.
using:
"sbatch shared4096" command you can execute the program
