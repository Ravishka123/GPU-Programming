...
GPU version for 4096 data sets using NVIDIA gtx device

Running the jobs
Copy the file RavishkaGPU1024.c and gpu4096 files
in your winscp folder.
using putty, go to the folder that contains above two files.
using:
"sbatch gpu4096" command you can execute the program
